        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu waves-effect waves-dark" href="Admin.jsp"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="FacultyList.jsp" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> Faculty List</a>
                    </li>
					<li>
                    ...
                    <li>
                        <a href="table.html" class="waves-effect waves-dark"><i class="fa fa-table"></i> Time Table</a>
                    </li>
                    <li>
